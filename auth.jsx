        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 20 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
            ...
            <span style={{ fontSize: 12, color: "var(--fg-3)" }}>
              {isSignUp ? "Free, and it links your devices." : "Welcome back."}
            </span>
          </div>
        </div>
    ...
    <div data-user-menu style={{ position: "relative" }}>
      ...
      {open && (
        <div style={{
          ...
          <MenuItem icon="gear" label="Manage account" onClick={() => { setOpen(false); auth.clerk && auth.clerk.openUserProfile({ appearance: clerkAppearance() }); }} />
...
Object.assign(window, {
  ...
  AuthModal, UserMenu, authenticatedFetch, clerkAppearance, API_URL,
});
