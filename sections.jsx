    ...
    <section id="download" className="sec" style={{ paddingTop: 0 }}>
      <div className="shell">
        <div className="sec-head center">
          ...
          <h2 className="h2">Free, and it stays that way.</h2>
          <p className="lead">No tiers, no paywalled modules, no nag screens. Create an account to link your devices and sync your configs — that's the whole catch.</p>
        </div>
...
const FAQS = [
  { q: "Is it actually free?", a: "Yes. Every module is unlocked for everyone. There are no tiers, no paywalls and no premium-only features — download it, sign in, and run it." },
        ...
        <div className="foot-grid">
          <div>
            ...
            <p className="small dim" style={{ maxWidth: 270 }}>
              A ghost client for Minecraft 1.8.9 and 1.7.10. Free to download, free to use.
            </p>
          </div>
          {cols.map(c => (
